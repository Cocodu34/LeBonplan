...
<html lang="fr"> 
   <head> 
      ...
      <link rel="stylesheet" href="/Livrable_v2/View/accueil.css">
...
.box {
    ...
    <header>
        <div class="navbar">
            ...
            <nav class="nav-items-container">
                <ul class="main-menu" id="main-menu">
                    <li class="menu-item"><a href="./accueil_etu.HTML" class="top-level-entry active">Accueil</a></li>
                    ...
                    <li class="menu-item"><a href="../Controler/recherche_etu.php" class="top-level-entry">Offre</a></li>
                </ul>
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="./accueil_etu.HTML">Accueil</a></li>
            </ol>
        </nav>
        <br>
     </header>
        ...
        <section class="job-listings">
          ...
          <div class="jobs-grid">
            <article class="job-card">
              ...
              <button id="verifier-btn">En savoir plus</button>
            </article>
            <article class="job-card">
